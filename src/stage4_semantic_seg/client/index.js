...
function takePicture(img) {
    ...
    var img = new Image();
    img.src = data;
    // Temp variables to store the previous bbox and image bytes to avoid processing every frame
    ...
    setTimeout(function () {
	// Set a timeout of 2 seconds to accomodate CocoSSD model loading
	takePicture();
    }, 2000);
}
